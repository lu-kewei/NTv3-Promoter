...
class TrainDataset(Dataset):
    def __init__(self, fasta_file,label_dir,token_num,batch_size,segmentnt_name,label_idx):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(segmentnt_name, trust_remote_code=True)
